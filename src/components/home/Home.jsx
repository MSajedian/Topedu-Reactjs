            ...
            <div className="home-background pt-2">
                <Container>
                    ...
                    <div className="d-flex justify-content-center">
                        <div>{userType === "admin" || userType === "instructor" ? <button className="btn-grad-blue" onClick={handleShowCreateCourseModal}>+ Create Course</button> : <></>}</div>
                    </div>
                                            ...
                                            <Col key={`course${index}`} className="">
                                                <Card className="position-relative border border-secondary box-shadow" >
                                                    ...
                                                    <Card.Body className="border border-primary border-end-0 border-bottom-0 border-start-0">
                                                        ...
                                                        {userType === "admin" || userType === "instructor" ?
                                                            <Button id={`delete-button${index}`} className="btn btn-danger position-absolute bottom-0 start-0 m-1 button-delete" onClick={() => (deleteCourse(course._id))}>
